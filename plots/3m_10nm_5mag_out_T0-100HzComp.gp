...
gpoutname = '3m_10nm_5mag_out_T0-100HzComp'
...
set title 'Coronagraph 100 Hz FSM Pointing Requirement (5th mag)'
...
splot '../output/3m_10nm_5mag/out_T0-3000.000000.dat' u 1:(4*($2/lambda)*lamD):3 w l, \
      '../output/3m_10nm_5mag/out_T0-1000.000000.dat' u 1:(4*($2/lambda)*lamD):3 w l, \
      '../output/3m_10nm_5mag/out_T0-300.000000.dat' u 1:(4*($2/lambda)*lamD):3 w l, \
      '../output/3m_10nm_5mag/out_T0-100.000000.dat' u 1:(4*($2/lambda)*lamD):3 w l, \
      '../output/3m_10nm_5mag/out_T0-30.000000.dat' u 1:(4*($2/lambda)*lamD):3 w l, \
      '../output/3m_10nm_5mag/out_T0-10.000000.dat' u 1:(4*($2/lambda)*lamD):3 w l, \
      '../output/3m_10nm_5mag/out_T0-3.000000.dat' u 1:(4*($2/lambda)*lamD):3 w l, \
      '../output/3m_10nm_5mag/out_T0-1.000000.dat' u 1:(4*($2/lambda)*lamD):3 w l
